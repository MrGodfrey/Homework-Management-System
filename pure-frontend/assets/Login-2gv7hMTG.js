...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    async function handleLogin() {
      var _a, _b;
      const payload = {
        student_id: form.student_id || "20230001",
        password: form.password || "20230001"
      };
      loading.value = true;
      try {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createVNode(_component_el_card, { class: "login-card" }, {
          default: withCtx(() => [
            _cache[5] || (_cache[5] = createBaseVNode("h2", null, "学生登录", -1)),
                ...
                createVNode(_component_el_form_item, { label: "学号" }, {
                  default: withCtx(() => [
                    createVNode(_component_el_input, {
                      modelValue: form.student_id,
                      "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => form.student_id = $event),
                      placeholder: "请输入学号"
                    }, null, 8, ["modelValue"])
                  ]),
                  _: 1
            ...
            createBaseVNode("div", _hoisted_2, [
              createVNode(_component_el_link, {
                onClick: _cache[2] || (_cache[2] = ($event) => _ctx.$router.push("/admin/login"))
              }, {
                default: withCtx(() => [..._cache[4] || (_cache[4] = [
                  createTextVNode("教师登录入口", -1)
                ])]),
                _: 1
              })
            ])
...
const Login = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f190c9ab"]]);
export {
  Login as default
};
